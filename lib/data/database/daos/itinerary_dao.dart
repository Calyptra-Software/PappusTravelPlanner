...
class ItineraryDao extends DatabaseAccessor<AppDatabase>
  ...
  Future<List<int>> insertJourneyLegs(
    ...
    return transaction(() async {
      ...
      // midnight, which would leave its final leg — or the morning an overnight
      // leg arrives in — on a day the trip does not cover: the timeline draws it, every reading of the *range* — the overview
