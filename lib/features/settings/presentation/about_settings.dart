...
///
/// Four rows, each of which answers a question the app cannot answer anywhere
...
/// how a report is not made. The licenses are Flutter's own page, which lists
/// every dependency's terms — plus the bundled fonts', registered in
/// `core/licenses.dart`, since those ship inside the binary too.
library;
